...
def build_or_load_memory():
    # Model lokalny - pobierze się raz (ok. 100MB) i działa u Ciebie na dysku
    ...
    # Tworzenie bazy - teraz to zajmie kilka sekund i nic nie wyśle do sieci
...
def main():
    ...
    if not key:
        ...
        # 1. Inicjalizujemy bazę wiedzy
        vectorstore = build_or_load_memory()

        prompt= """Odpowiedz na pytanie wyłącznie na podstawie poniższego kontekstu.
